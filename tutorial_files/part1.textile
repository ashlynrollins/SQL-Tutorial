...
Just so we'll have some data to play with, let's execute a couple of other @INSERT@ statements. Go back to the "Execute SQL" tab and paste in these lines:
...
bq. Before inserting these new records, you should delete the original @INSERT@ statement to avoid re-inserting it.

Click "Execute SQL".

Again, you can view the results in the "Browse Data" tab. *You should see 4 records in total now.*
